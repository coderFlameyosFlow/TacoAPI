...
dependencies {
    compileOnly "com.github.:VaultAPI:1.7"
}
```
...
public class ExamplePlugin extends JavaPlugin {
    ...
    private boolean setupEconomy() {
        ...
        RegisteredServiceProvider<AbstractEconomy> rsp = getServer().getServicesManager().getRegistration(AbstractEconomy.class);
        if (rsp == null) {
            return false;
        }
    ...
    public static AbstractEconomy getEconomy() {
        return econ;
    }
